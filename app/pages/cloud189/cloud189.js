...
Page({
  ...
  submitForm(e) {
    ...
    this.selectComponent('#form').validate((valid, errors) => {
      ...
      if (!valid) {
        ...
        // })
        wx.request({
          url: app.globalData.baseUrl + '/cloud189/create', //仅为示例，并非真实的接口地址
          method: 'POST',
          data: {
  ...
  deleteAccount() {
    var _this = this;
    wx.request({
      url: app.globalData.baseUrl + '/cloud189/delete', //仅为示例，并非真实的接口地址
      method: 'POST',
      data: {
        userId: app.globalData.openId,
      },
  ...
  onReady: function () {
    ...
    wx.request({
      url: app.globalData.baseUrl + '/cloud189/get', //仅为示例，并非真实的接口地址
      method: 'POST',
      data: {
        userId: app.globalData.openId,
      },
